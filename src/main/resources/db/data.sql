...
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('1번째 댓글', 1, 1, now());
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('2번째 댓글', 1, 2, now());
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('3번째 댓글', 2, 1, now());
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('4번째 댓글', 2, 2, now());
